...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_button\" href='".str_replace("{page}",$prepagenum,$tnamerule)."'><i class=\"fa fa-chevron-left trans middle\"></i></a>\r\n";
        ...
        {
            $nextpage.="<a class=\"page_button\" href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i class=\"fa fa-chevron-right trans middle\"></i></a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<font class=\"page_item_current\">$j</font>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a class=\"page_button\" href='".$purl."PageNo=$prepagenum'><i class=\"fa fa-chevron-left trans middle\"></i></a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"page_button\" href='".$purl."PageNo=$nextpagenum'><i class=\"fa fa-chevron-right trans middle\"></i></a>\r\n";
